...
@export var region1: MapRegion = MapRegion.new()
@export var region2: MapRegion = MapRegion.new()
@export var region3: MapRegion = MapRegion.new()
@export var region4: MapRegion = MapRegion.new()
@export var region5: MapRegion = MapRegion.new()
@export var region6: MapRegion = MapRegion.new()
@export var region7: MapRegion = MapRegion.new()
@export var region8: MapRegion = MapRegion.new()
@export var region9: MapRegion = MapRegion.new()
@export var region10: MapRegion = MapRegion.new()
@export var region11: MapRegion = MapRegion.new()
